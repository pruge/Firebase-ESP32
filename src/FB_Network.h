...
#if defined(INC_ENC28J60_LWIP) || defined(INC_W5100_LWIP) ||                   \
    defined(INC_W5500_LWIP)
#define FIREBASE_ETH_IS_AVAILABLE
#endif
...
#if __has_include(                                                             \
    <Ethernet.h>) ||  (defined(FIREBASE_ETHERNET_MODULE_LIB) && defined(FIREBASE_ETHERNET_MODULE_CLASS))

#if defined(ESP8266)
#undef MAX_SOCK_NUM
#endif

#if (defined(ESP8266) && defined(FIREBASE_DISABLE_NATIVE_ETHERNET)) ||         \
    (!defined(ESP8266) && !defined(ARDUINO_NANO_RP2040_CONNECT))

#if defined(FIREBASE_ETHERNET_MODULE_LIB) &&                                   \
    defined(FIREBASE_ETHERNET_MODULE_CLASS)
...
#elif FIREBASE_ETHERNET_MODULE_TIMEOUT <= 0 ||                                 \
    FIREBASE_ETHERNET_MODULE_TIMEOUT > 120 * 1000
...
#include <WiFi.h>
    ...
    defined(ARDUINO_RASPBERRY_PI_PICO_W) || defined(ARDUINO_UNOWIFIR4) ||      \
    defined(ARDUINO_PORTENTA_C33) || defined(ARDUINO_PORTENTA_H7_M7) ||        \
...
// #endif
    ...
    !defined(MB_ARDUINO_MBED_PORTENTA) && !defined(ARDUINO_UNOWIFIR4) &&       \
    !defined(ARDUINO_PORTENTA_C33) && !defined(ARDUINO_NANO_RP2040_CONNECT)
...
#define FIREBASE_HAS_WIFIMULTI
    ...
    defined(TINY_GSM_MODEM_SIM7000) || defined(TINY_GSM_MODEM_SIM7000) ||      \
    defined(TINY_GSM_MODEM_SIM7000SSL) || defined(TINY_GSM_MODEM_SIM7070) ||   \
    defined(TINY_GSM_MODEM_SIM7080) || defined(TINY_GSM_MODEM_SIM7090) ||      \
    defined(TINY_GSM_MODEM_SIM5320) || defined(TINY_GSM_MODEM_SIM5360) ||      \
    defined(TINY_GSM_MODEM_SIM5300) || defined(TINY_GSM_MODEM_SIM7100) ||      \
    defined(TINY_GSM_MODEM_SIM7600) || defined(TINY_GSM_MODEM_SIM7800) ||      \
    defined(TINY_GSM_MODEM_SIM7500) || defined(TINY_GSM_MODEM_UBLOX) ||        \
    defined(TINY_GSM_MODEM_SARAR4) || defined(TINY_GSM_MODEM_M95) ||           \
    defined(TINY_GSM_MODEM_BG96) || defined(TINY_GSM_MODEM_A6) ||              \
    defined(TINY_GSM_MODEM_A7) || defined(TINY_GSM_MODEM_M590) ||              \
    defined(TINY_GSM_MODEM_MC60) || defined(TINY_GSM_MODEM_MC60E) ||           \
